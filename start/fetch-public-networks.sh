...
mkdir -p "$POOL_DIR"/SOVRIN_TESTNET
...
curl -s https://raw.githubusercontent.com/sovrin-foundation/sovrin/master/sovrin/pool_transactions_sandbox_genesis > "$POOL_DIR"/SOVRIN_TESTNET/SOVRIN_TESTNET.txn
...
echo "Staging-net network genesis saved to: $POOL_DIR/SOVRIN_TESTNET/SOVRIN_TESTNET.txn"

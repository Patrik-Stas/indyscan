...
async function bootstrapApp (objectsConfig) {
  ...
  const configProcessors = objectsConfig.filter(o => o.interface.toLowerCase() === interfaces.transformer)
  const configPipelines = objectsConfig.filter(o => o.interface.toLowerCase() === interfaces.worker)
